...
<body>
    <header class="header-fijo">
        ...
        <div id="notificacion-carrito" class="notificacion-carrito">
            <span id="mensaje-carrito">✅ Agregado al Carrito</span>
            <div id="producto-preview">
                <img id="preview-img" src="" alt="Producto" class="preview-img">
        ...
        <div class="header-usuario">
            <?php if (isset($_SESSION['nombre_usuario'])): ?>
                ...
                <a href="ver_carrito.php" class="boton-carrito">Mi Carrito</a>
                <a href="mis_compras.php" class="boton-compras">Mis Compras</a>
            ...
            <?php else: ?>
                ...
                <a class="boton-ingreso" href="index.html">Página Principal</a>
            <?php endif; ?>
        </div>
    </header>
    ...
    <div class="background-image">
        <div class="seccion-producto">
            <h2 class="titulo-seccion">Lo que necesitas para tu Perro</h2>
            <h3 class="titulo-subseccion">Alimento</h3>
            <div class="Productos">
                <div class="card">
        ...
        <div class="seccion-producto">
            <h2 class="titulo-seccion">Lo que necesitas para tu Gato</h2>

            <div class="subseccion-producto">
                <h3 class="titulo-subseccion">Alimento</h3>
                <div class="Productos">
                    <div class="card">
            ...
            <div class="subseccion-producto">
                <h3 class="titulo-seccion">Alimento en Sobre</h3>
                <div class="Productos">
                    <div class="card">
            ...
            <div class="subseccion-producto">
                <h3 class="titulo-seccion">Alimento en Lata</h3>
                <div class="Productos">
                    <div class="card">
            ...
            <div class="subseccion-producto">
                <h3 class="titulo-seccion">Piedras Sanitarias</h3>
                <div class="Productos">
                    <div class="card">
            ...
            <div class="subseccion-producto">
                <h3 class="titulo-seccion">Shampoo para Perro y Gato</h3>
...
document.addEventListener('DOMContentLoaded', () => {
    // 1. Seleccionar todos los formularios del carrito
    const formularios = document.querySelectorAll('form[action="agregar_carrito.php"]');
    const notificacion = document.getElementById('notificacion-carrito');
    const previewImg = document.getElementById('preview-img');
    const previewNombre = document.getElementById('preview-nombre');

    // 2. Adjuntar el evento a cada formulario
    formularios.forEach(form => {
        form.addEventListener('submit', function(e) {
            // Detiene la recarga de la página y el desplazamiento al header
            e.preventDefault();

            const formData = new FormData(form);
            
            // Obtener los datos del producto para la previsualización
            const card = form.closest('.card');
            const imgSrc = card.querySelector('img').src;
            const nombreProd = card.querySelector('h3').textContent;

            // Enviar los datos usando fetch (AJAX)
            ...
            .then(data => {
                // Mostrar la previsualización y el mensaje
                previewImg.src = imgSrc;
                previewNombre.textContent = nombreProd;
                ...
                // Puedes usar 'data' si necesitas leer un mensaje de éxito desde agregar_carrito.php
                // console.log(data); 
